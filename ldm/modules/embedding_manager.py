...
class EmbeddingManager(nn.Module):
    ...
    def load(self, ckpt_path, device='cpu'):
    ...
    def embedding_to_density_loss(self, token_embeddings):
        ...
        for key in self.initial_embeddings:
            ...
            # TODO: not sure about the details of the density regularization loss
            loss = loss - torch.exp(-(optimized-token_embeddings).square().sum(dim=-1) / (2.0 * 0.2**2)).mean()
